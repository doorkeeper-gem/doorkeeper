  ...
  describe ErrorResponse do
    ...
    describe :from_request do
      it 'has the error from request' do
        error = ErrorResponse.from_request double(error: :some_error, error_description_key: nil)
      ...
      it 'has state if request responds to state' do
        error = ErrorResponse.from_request double(error: :some_error, state: :hello, error_description_key: nil)
