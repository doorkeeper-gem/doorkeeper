...
RSpec.describe Doorkeeper::OAuth::ClientAuthentication::ClientSecretPost do
  describe ".matches_request?" do
    ...
    it "doesn't match if the credentials are in the query parameters" do
      request = mock_request(query_parameters: { client_id: "1234", client_secret: "5678" })
  ...
  describe ".authenticate" do
    it "returns credentials using the values from the request body" do
