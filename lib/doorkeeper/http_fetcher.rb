...
module Doorkeeper
  ...
  class HttpFetcher
    ...
    # error.
    #
    # Note that this include some errors that can happen after establishing a
    ...
    def connection_for(uri, address, deadline)
      Net::HTTP.new(uri.host, uri.port).tap do |http|
        ...
        # more than `OPEN_TIMEOUT`.
        http.open_timeout = [OPEN_TIMEOUT, remaining_until(deadline) / 2.0].min
