    ...
    module Helpers
      ...
      def valid_doorkeeper_token?
        doorkeeper_token&.acceptable?(@_doorkeeper_scopes) &&
          satisfied_doorkeeper_token_dpop_binding?
      end

      def satisfied_doorkeeper_token_dpop_binding?
      ...
      def doorkeeper_invalid_token_response?
        !doorkeeper_token || !doorkeeper_token.accessible? || !satisfied_doorkeeper_token_dpop_binding?
      end
