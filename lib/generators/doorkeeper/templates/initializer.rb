...
Doorkeeper.configure do
  ...
  #
  # The second form also revokes the access tokens already issued to the
  # application and its unredeemed authorization codes, which the leaked
  # secret is enough to exchange.
  #
